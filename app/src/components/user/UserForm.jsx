...
const UserForm = (user) => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            if (id) {
                result = await UserService.update({ user_id: id, user_username: username, user_email: email, user_phone: phone });
            } else {
                result = await UserService.create({ user_username: username, user_email: email, user_phone: phone, user_pass: '1234' });
            }
